...
command! -bang -nargs=*  All
            \ call fzf#run(fzf#wrap({'source': 'rg -l --files --hidden --no-ignore-vcs --glob "!{node_modules/*,.git/*,.tmp-metadata/*}"', 'down': '40%', 'options': fzfOptions }))
